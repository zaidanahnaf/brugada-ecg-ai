...
try:
    cnn_df = pd.read_csv("outputs/features/cnn_embeddings.csv")
...
comparison_df = run_key_comparisons(results_dir="outputs/results/ablation")
...
# Save conclusions
with open("outputs/results/ablation/mandatory_conclusions.txt", 'w') as f:
    for q_id, text in conclusions.items():
        f.write(f"[{q_id}]\n{text}\n\n")

print("\nAblation study complete.")
print(f"  Master table: outputs/results/ablation/ablation_master_table.csv")
print(f"  Comparisons:  outputs/results/ablation/key_comparisons.csv")
print(f"  Conclusions:  outputs/results/ablation/mandatory_conclusions.txt")