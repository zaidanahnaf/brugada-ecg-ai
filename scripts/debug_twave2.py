...
t_start_rr = r_sample + int(CFG.t_wave_start_fraction * rr_samples)
t_end_rr   = r_sample + int(CFG.t_wave_end_fraction   * rr_samples)

print(f"CFG.beat_window_pre_ms   : {CFG.beat_window_pre_ms}")
print(f"CFG.beat_window_post_ms  : {CFG.beat_window_post_ms}")
print(f"CFG.t_wave_start_fraction: {CFG.t_wave_start_fraction}")
print(f"CFG.t_wave_end_fraction  : {CFG.t_wave_end_fraction}")
print(f"CFG.t_wave_fallback_start_ms: {CFG.t_wave_fallback_start_ms}")
print(f"CFG.t_wave_fallback_end_ms  : {CFG.t_wave_fallback_end_ms}")
print()
...
# Fallback
t_fb_start = r_sample + int(CFG.t_wave_fallback_start_ms * fs / 1000)
t_fb_end   = r_sample + int(CFG.t_wave_fallback_end_ms   * fs / 1000)
